...
How can I help you?
    ...
    * [Do you have any quests?]
        {allQuestDone:I do not require assistance for now.|{(!GeologistValidTime): Thanks for the help! Maybe come another time. |{GeologistQuestStarted:I have already given you a quest. -> in_quest|{(!questHSA1000Done): -> HSA1000Convo |{(!questGESS1001Done): -> GESS1001Convo |{(!questGEA1000Done): ->GEA1000}}}}}}
        -> DONE
    * [Leave]
        Goodbye.
        -> DONE
